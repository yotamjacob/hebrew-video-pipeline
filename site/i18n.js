...
(function () {
  ...
  const I18N = {
    ...
    'stock.edgeDrops':   { en: '{n} needed more footage around {them} - too close to the video\'s start or end', he: '{n} נדרשו ליותר וידאו סביבם - קרובים מדי לתחילת הסרטון או לסופו' },
    'stock.spacingDrops': { en: '{n} too close to another insert - clips keep about 8 seconds apart', he: '{n} קרובים מדי לשיבוץ אחר - נשמר מרווח של כ-8 שניות בין קליפים' },
    'stock.dropped':     { en: 'Found {n} B-roll moment{s}, but there was not enough room in the video to place {them}{detail}.', he: 'נמצאו {n} רגעים לבי-רול, אבל לא היה מספיק אורך וידאו כדי לשבץ אותם{detail}.' },
