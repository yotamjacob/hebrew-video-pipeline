...
(function () {
  ...
  const I18N = {
    ...
    'boot.waking':     { en: 'Loading the latest updates from the server...', he: 'טוענים את העדכונים האחרונים מהשרת...' },
    ...
    'auth.migrationNote': { en: 'We have a new look! Signing in now works with your email or Google - passwords are gone. If you can\'t get into your account, <a href="mailto:hebrewpipeline@gmail.com" onclick="openContactModal();return false;">contact us</a> and we\'ll help.', he: 'התחדשנו! ההתחברות עכשיו עם קוד למייל או עם Google - בלי סיסמאות. אם לא מצליחים להיכנס לחשבון, <a href="mailto:hebrewpipeline@gmail.com" onclick="openContactModal();return false;">צרו קשר</a> ונעזור.' },
    ...
    'capedit.previewLoading': { en: 'Preview loading...', he: 'התצוגה המקדימה נטענת...' },
    ...
    'hook.generating':   { en: 'Generating…', he: 'בתהליך יצירה…' },
    ...
    'style.designTitle': { en: 'Caption design', he: 'עיצוב הכתוביות' },
    'preset.tabSystem':  { en: 'Ready-made', he: 'מוכנים' },
    'preset.tabMine':    { en: 'My styles', he: 'שלי' },
    'preset.saveCurrent': { en: '+ Save current style', he: '+ שמירת הסגנון הנוכחי' },
    'preset.namePh':     { en: 'Style name', he: 'שם הסגנון' },
    'preset.save':       { en: 'Save', he: 'שמירה' },
    'preset.noneSaved':  { en: 'No saved styles yet - tune the design and save it here.', he: 'אין עדיין סגנונות שמורים - כוונו את העיצוב ושמרו אותו כאן.' },
    ...
    'preset.news':       { en: 'News box', he: 'כתבה' },
    'preset.viral':      { en: 'Viral yellow', he: 'צהוב ויראלי' },
    'preset.invert':     { en: 'Light box', he: 'בהיר' },
    ...
    'fx.zoom':       { en: 'Auto punch-in zoom', he: 'זום אוטומטי ברגעי דגש' },
    'fx.zoomSubtle': { en: 'Subtle', he: 'עדין' },
    'fx.zoomMedium': { en: 'Medium', he: 'בינוני' },
    'fx.zoomStrong': { en: 'Strong', he: 'חזק' },
    'fx.zoomNote':   { en: 'Punches in toward the face at sentence starts after a pause (up to ~4 per minute). Tap a moment below to skip it.', he: 'זום פנימה לכיוון הפנים בתחילת משפטים אחרי הפסקה (עד ~4 בדקה). הקישו על רגע למטה כדי לדלג עליו.' },
    ...
    'profile.saveBtn': { en: 'Save', he: 'שמירה' },
    'profile.namePh':  { en: 'Profile name…', he: 'שם הפרופיל…' },
    'profile.applied': { en: 'Profile "{name}" applied', he: 'הפרופיל "{name}" הוחל' },
    'profile.saved':   { en: 'Profile "{name}" saved', he: 'הפרופיל "{name}" נשמר' },
    'profile.nameExists': { en: 'A profile named "{name}" already exists - choose a different name', he: 'פרופיל בשם "{name}" כבר קיים - בחרו שם אחר' },
    ...
    'cost.aiFeature':  { en: 'AI feature', he: 'כלי AI' },
    'cost.calls':      { en: 'Calls', he: 'קריאות' },
    'cost.spend':      { en: 'Spend', he: 'הוצאה' },
    'cost.plansTitle': { en: 'Pricing plans', he: 'תוכניות תמחור' },
    'cost.plan':       { en: 'Pack', he: 'חבילה' },
    'cost.planProfit': { en: 'Profit', he: 'רווח' },
    'cost.planMargin': { en: 'Margin', he: 'שוליים' },
    'cost.planCredits': { en: '{n} credits', he: '{n} קרדיטים' },
    'cost.planEach':   { en: '{total}, {each} each', he: '{total}, {each} לקרדיט' },
    'cost.serveCost':  { en: 'Cost per credit', he: 'עלות לקרדיט' },
    'cost.breakEven':  { en: 'Break-even', he: 'נקודת איזון' },
    'cost.floor':      { en: 'Floor for 90% margin', he: 'רצפה ל-90% רווח' },
    'cost.plansNote':  { en: 'Derived from the measured cost per video above, treating one credit as one average video (a long video or an upscale costs more than one credit, so this leans conservative). Assumes the {fee}% Google Play commission and a rate of {fx} shekels to the dollar. Excludes tax and any unredeemed credits. Pack prices are set in Play Console - keep PLAY_PACKS in app.js in sync.',
                         he: 'מחושב מעלות הסרטון הנמדדת שלמעלה, בהנחה שקרדיט אחד שווה לסרטון ממוצע אחד (סרטון ארוך או שדרוג ל-4K עולים יותר מקרדיט אחד, ולכן ההערכה שמרנית). מניח עמלת Google Play של {fee}% ושער של {fx} שקלים לדולר. לא כולל מס ולא קרדיטים שלא נוצלו. מחירי החבילות נקבעים ב-Play Console - יש לעדכן את PLAY_PACKS ב-app.js בהתאם.' },
    'cost.plansNeedData': { en: 'Process a video in this window to derive pricing from real costs.', he: 'צריך לעבד סרטון בטווח הזה כדי לגזור תמחור מעלויות אמיתיות.' },
    ...
    'share.preparing': { en: 'Preparing video to share...', he: 'הכנת הסרטון לשיתוף...' },
    ...
    'srt.preparing': { en: 'Preparing subtitles...', he: 'הכנת קובץ הכתוביות...' },
    ...
    'download.saving':    { en: 'Saving video...', he: 'הסרטון נשמר...' },
    'download.savingPct': { en: 'Saving video... {pct}%', he: 'הסרטון נשמר... {pct}%' },
    'download.saved':     { en: 'Saved to Documents', he: 'הסרטון נשמר בתיקייה Documents' },
    'download.readyWatch': { en: 'The video is downloaded and ready to watch', he: 'הסרטון ירד ומוכן לצפייה' },
    'download.starting':  { en: 'Starting download...', he: 'ההורדה מתחילה...' },
    ...
    'download.notification': { en: 'Downloading Pipeline video', he: 'הורדת סרטון מפייפליין' },
    ...
    'sched.suggesting':  { en: 'Generating caption…', he: 'הכיתוב נכתב…' },
    ...
    'sched.sending':     { en: 'Sending to Metricool…', he: 'נשלח ל-Metricool…' },
    ...
    'prog.finalize':    { en: 'Loading preview', he: 'טעינת תצוגה מקדימה' },
    ...
    // ── History ──
    'prog.save':       { en: 'Saving video', he: 'שמירת הסרטון' },
    'prog.saveDl':     { en: 'Preparing download', he: 'הכנת הקובץ להורדה' },
    ...
    'hist.loading':    { en: 'Loading…', he: 'בטעינה…' },
    ...
    'upload.srcTitle':   { en: 'Add a video', he: 'הוספת סרטון' },
    'upload.srcRecord':  { en: 'Record a video now', he: 'צילום סרטון עכשיו' },
    'upload.srcFile':    { en: 'Choose from device', he: 'בחירה מהמכשיר' },
    ...
    'notice.tooBig':       { en: 'Max size is 1 GB. This file is {size}. Try a lower resolution or shorter clip.', he: 'הגודל המרבי הוא 1 GB. הקובץ הזה שוקל {size}. נסו רזולוציה נמוכה יותר או קטע קצר יותר.' },
    ...
    'admin.deleteUser':  { en: 'Delete', he: 'מחיקה' },
    'admin.deleteTitle': { en: 'Delete this account?', he: 'למחוק את החשבון?' },
    'admin.deleteBody':  { en: 'This permanently deletes {name}: videos, history and credits. The same email can sign up again later as a brand-new account.', he: 'פעולה זו מוחקת לצמיתות את {name}: סרטונים, היסטוריה וקרדיטים. אפשר יהיה להירשם שוב עם אותו אימייל כחשבון חדש לגמרי.' },
    'admin.deleteFailed': { en: 'Delete failed', he: 'המחיקה נכשלה' },
    ...
    'run.burning':       { en: 'Burning…', he: 'בצריבה…' },
    'run.downloading':   { en: 'Downloading…', he: 'בהורדה…' },
    ...
    'stock.searching':   { en: 'Searching…', he: 'בחיפוש…' },
    ...
    'stock.noMatch':     { en: 'No stock clips matched this moment.', he: 'אף קליפ לא התאים לרגע הזה.' },
    ...
    'sched.generating':    { en: 'Generating…', he: 'בתהליך יצירה…' },
    ...
    'billing.loading':  { en: 'Loading Google Play prices…', he: 'טעינת מחירים מ-Google Play…' },
    ...
    'guide.upload.body':  { en: 'In the Create tab, tap Choose File and pick a Hebrew talking video (up to 1 GB).<ul><li>Clearer audio means more accurate captions.</li><li>Vertical videos work best for reels and stories; horizontal videos work too.</li><li>Audio files (mp3, wav, ogg and more) also work - you get edited clean audio plus captions as an SRT file.</li><li>Keep the window open while the file uploads. Once processing starts you can switch away - it finishes on our servers.</li><li>On a shaky mobile connection the upload resumes on its own; if it fails, just pick the file again.</li></ul>', he: 'בלשונית "יצירה" הקישו "בחירת קובץ" ובחרו סרטון דיבור בעברית (עד 1GB).<ul><li>אודיו ברור יותר = כתוביות מדויקות יותר.</li><li>סרטונים אנכיים מתאימים במיוחד לרילים וסטוריז; גם סרטונים רוחביים עובדים.</li><li>גם קובצי אודיו (mp3, wav, ogg ועוד) עובדים - מקבלים אודיו נקי וערוך + כתוביות כקובץ SRT.</li><li>השאירו את החלון פתוח בזמן ההעלאה. ברגע שהעיבוד מתחיל אפשר לעבור לאפליקציה אחרת - הוא ממשיך בשרת.</li><li>בחיבור סלולרי חלש ההעלאה מתחדשת לבד; אם היא נכשלת, פשוט בחרו שוב את הקובץ.</li></ul>' },
    'guide.options.title': { en: 'Edit options', he: 'אפשרויות עריכה' },
    'guide.options.body':  { en: 'Before you run, choose what the pipeline should do. Processing uses one credit; a video over 10 minutes and the AI upscale each add one, and the cost is shown before you confirm.<ul><li><b>Cut silences</b> - removes the gaps between spoken parts. The aggressiveness slider sets how long a pause must be before it is cut (higher = tighter).</li><li><b>Hebrew captions</b> - word-level captions burned into the video.</li><li><b>Audio enhance</b> - noise reduction with DeepFilterNet.</li><li><b>Video enhance</b> - Off, light filters, or AI upscale up to 4K (adds processing time).</li><li><b>Auto B-roll &amp; auto hook</b> - when captions are on, these prepare B-roll suggestions and hook options in the background, so they are ready by the time you finish reviewing the captions.</li></ul>', he: 'לפני ההפעלה, בחרו מה הפייפליין יעשה. העיבוד מנצל קרדיט אחד; סרטון מעל 10 דקות ושדרוג ה-AI מוסיפים קרדיט כל אחד, והעלות מוצגת לפני האישור.<ul><li><b>חיתוך שתיקות</b> - מסיר את ההפסקות בין קטעי הדיבור. סרגל העוצמה קובע כמה ארוכה צריכה להיות הפסקה כדי שתיחתך (גבוה = צפוף יותר).</li><li><b>כתוביות בעברית</b> - כתוביות ברמת מילה, צרובות בסרטון.</li><li><b>שיפור אודיו</b> - הפחתת רעשים עם DeepFilterNet.</li><li><b>שיפור וידאו</b> - כבוי, פילטרים קלים, או שדרוג AI עד 4K (מוסיף זמן עיבוד).</li><li><b>בי-רול אוטומטי והוק אוטומטי</b> - כשהכתוביות פעילות, אלה מכינים הצעות בי-רול ואפשרויות הוק ברקע, כך שהם מוכנים עד שתסיימו לעבור על הכתוביות.</li></ul>' },
    'guide.profiles.title': { en: 'My profiles - save your setup', he: 'הפרופילים שלי - שמירת ההגדרות' },
    'guide.profiles.body':  { en: 'Profiles save your whole setup - edit options, caption look, effects and hook design - so the next video starts exactly the way you like.<ul><li>Set everything up once, then tap "+ Save current setup" at the top of the Options card and give it a name.</li><li>Tap a profile chip to apply it any time.</li><li>Tap the star to make a profile your default - it is applied automatically when the app opens.</li><li>Profiles are saved to your account, so they follow you across devices.</li><li>You can keep up to 6 profiles; delete one to make room for a new one.</li></ul>', he: 'פרופילים שומרים את כל ההגדרות שלכם - אפשרויות עריכה, עיצוב כתוביות, אפקטים ועיצוב הוק - כך שהסרטון הבא מתחיל בדיוק כמו שאתם אוהבים.<ul><li>כווננו הכול פעם אחת, ואז הקישו "+ שמירת ההגדרות הנוכחיות" בראש כרטיס האפשרויות ותנו שם.</li><li>הקישו על תווית פרופיל כדי להחיל אותו בכל רגע.</li><li>הקישו על הכוכב כדי להפוך פרופיל לברירת מחדל - הוא מוחל אוטומטית בפתיחת האפליקציה.</li><li>הפרופילים נשמרים בחשבון שלכם ועוברים איתכם בין מכשירים.</li><li>אפשר לשמור עד 6 פרופילים; מחקו אחד כדי לפנות מקום לחדש.</li></ul>' },
    'guide.captions.title': { en: 'Caption editor', he: 'עריכת כתוביות' },
    'guide.captions.body':  { en: 'After processing you land in the video editor: one live preview on top, with Captions / Hook / B-roll / Effects tabs under it. Everything you see in the preview is exactly what gets burned.<ul><li>Edit the text of any line directly; adjust start and end times, or use the scissors / plus / minus to split, add, or remove lines.</li><li>Pick a font and a size (in pixels of the final video), and choose how captions appear: classic lines, one word at a time, or karaoke highlight.</li><li>Set the text and outline colors, or add a background box with its own color and opacity - every color swatch opens a full in-app picker, custom shades included.</li><li>Start from a Quick style, or save your own look under "My styles" - saved styles keep the caption position too.</li><li>Drag the caption up or down on the preview itself to position it.</li><li>While the preview is paused it shows a pixel-exact render of the final result.</li><li>Need the raw subtitles? Download an SRT file.</li></ul>', he: 'אחרי העיבוד נכנסים לעורך הווידאו: תצוגה מקדימה חיה למעלה, ומתחתיה הלשוניות כתוביות / הוק / בי-רול / אפקטים. מה שרואים בתצוגה המקדימה הוא בדיוק מה שנצרב.<ul><li>ערכו את הטקסט של כל שורה ישירות; כווננו זמני התחלה וסיום, או השתמשו במספריים / פלוס / מינוס כדי לפצל, להוסיף או להסיר שורות.</li><li>בחרו גופן וגודל (בפיקסלים של הסרטון הסופי), ובחרו איך הכתוביות מופיעות: שורות קלאסיות, מילה אחת בכל פעם, או הדגשת קריוקי.</li><li>קבעו צבע טקסט וצבע מסגרת, או הוסיפו ריבוע רקע עם צבע ושקיפות משלו - כל ריבוע צבע פותח בורר צבעים מלא בתוך האפליקציה, כולל גוונים מותאמים.</li><li>התחילו מסגנון מוכן, או שמרו עיצוב משלכם תחת "שלי" - סגנונות שמורים שומרים גם את מיקום הכתוביות.</li><li>גררו את הכתובית למעלה או למטה על התצוגה המקדימה עצמה כדי למקם אותה.</li><li>כשהתצוגה המקדימה מושהית היא מציגה רינדור מדויק עד הפיקסל של התוצאה הסופית.</li><li>צריכים את קובץ הכתוביות הגולמי? הורידו קובץ SRT.</li></ul>' },
    'guide.hook.title': { en: 'Hook generator', he: 'מחולל ההוקים' },
    'guide.hook.body':  { en: 'A hook is a short opening line that appears in the first seconds to stop the scroll. It lives in the Hook tab of the editor.<ul><li>Tap Generate hook options (available 3 times per video) - the AI reads your transcript and suggests a few, each with a short reason.</li><li>Pick one - and edit its text freely in the field (the pencil marks it as editable).</li><li>Customize font, text color, background, size and timing; drag the hook on the preview to position it.</li><li>Save it as a template (position included) to reuse your style next time.</li><li>The hook is burned in together with the captions.</li></ul>', he: 'הוק הוא משפט פתיחה קצר שמופיע בשניות הראשונות כדי לעצור את הגלילה. הוא נמצא בלשונית "הוק" של העורך.<ul><li>הקישו "יצירת אפשרויות הוק" (זמין 3 פעמים לכל סרטון) - ה-AI קורא את התמלול ומציע כמה, כל אחת עם נימוק קצר.</li><li>בחרו אחת - ואפשר לערוך את הטקסט שלה חופשי בשדה (העיפרון מסמן שהוא ניתן לעריכה).</li><li>התאימו גופן, צבע טקסט, רקע, גודל ותזמון; גררו את ההוק על התצוגה המקדימה כדי למקם אותו.</li><li>שמרו כתבנית (כולל המיקום) כדי להשתמש שוב בסגנון שלכם בפעם הבאה.</li><li>ההוק נצרב יחד עם הכתוביות.</li></ul>' },
    'guide.broll.title': { en: 'B-roll finder', he: 'מאתר הבי-רול' },
    'guide.broll.body':  { en: 'B-roll lays relevant stock clips over parts of your video to keep it visually interesting. It lives in the B-roll tab of the editor.<ul><li>Tap Find B-roll moments - the app picks moments from your transcript and fetches matching stock clips from Pexels and Pixabay.</li><li>For any moment you can swap in a different clip; selected clips play right in the preview during their moment.</li><li>Selected clips are composited in when you burn.</li><li>This is the most compute-heavy feature, so it is available 3 times per video. If you change your captions afterward, re-run it to refresh.</li></ul>', he: 'בי-רול מניח קטעי סטוק רלוונטיים מעל חלקים בסרטון כדי לשמור על עניין ויזואלי. הוא נמצא בלשונית "בי-רול" של העורך.<ul><li>הקישו "איתור רגעי בי-רול" - האפליקציה בוחרת רגעים מהתמלול ומביאה קטעי סטוק מתאימים מ-Pexels ומ-Pixabay.</li><li>לכל רגע אפשר להחליף לקטע אחר; קטעים שנבחרו מתנגנים ישירות בתצוגה המקדימה ברגע שלהם.</li><li>הקטעים שנבחרו משולבים בסרטון בזמן הצריבה.</li><li>זו התכונה הכבדה ביותר בעיבוד, ולכן היא זמינה 3 פעמים לכל סרטון. אם שיניתם כתוביות אחר כך, הריצו שוב כדי לרענן.</li></ul>' },
    'guide.effects.title': { en: 'Effects - zoom &amp; progress bar', he: 'אפקטים - זום ופס התקדמות' },
    'guide.effects.body':  { en: 'The Effects tab of the editor adds retention extras that are burned into the final video.<ul><li><b>Auto punch-in zoom</b> - the app finds emphasis moments (a sentence starting after a pause) and smoothly punches in toward the speaker\'s face, like a real camera move. Choose Subtle, Medium or Strong.</li><li>Every planned zoom appears as a chip with its time and text - tap a chip to skip that moment, tap again to bring it back.</li><li><b>Progress bar</b> - a thin bar along the top of the video that fills as it plays, in any color you pick.</li><li>Everything shows live in the preview - what you see is what gets burned.</li></ul>', he: 'לשונית "אפקטים" בעורך מוסיפה תוספות ריטנשן שנצרבות בסרטון הסופי.<ul><li><b>זום אוטומטי ברגעי דגש</b> - האפליקציה מאתרת רגעי הדגשה (משפט שמתחיל אחרי הפסקה) ומתקרבת בצורה חלקה אל פני הדוברים, כמו תנועת מצלמה אמיתית. בחרו עדין, בינוני או חזק.</li><li>כל זום מתוכנן מופיע כתווית עם הזמן והטקסט שלו - הקישו על תווית כדי לדלג על הרגע, והקישו שוב כדי להחזיר אותו.</li><li><b>פס התקדמות</b> - פס דק בראש הסרטון שמתמלא תוך כדי ניגון, בכל צבע שתבחרו.</li><li>הכול מוצג חי בתצוגה המקדימה - מה שרואים הוא מה שנצרב.</li></ul>' },
    ...
    'guide.schedule.body':  { en: 'Send a finished video straight to your social channels through Metricool.<ul><li>Tap Schedule - on the video right after burning, or on any row in History.</li><li>Choose the platforms (Instagram, Facebook, TikTok, YouTube), set the date and time, and write a caption - or tap "Suggest caption from video" to let the AI draft one from your transcript (available 3 times per video).</li><li>With Auto-publish off (default), the post waits for your final approval inside Metricool. Turn it on to publish automatically.</li><li>You need a connected Metricool account first (see below).</li></ul>', he: 'שלחו סרטון מוגמר ישירות לערוצים החברתיים שלכם דרך Metricool.<ul><li>הקישו "תזמון" - על הסרטון מיד אחרי הצריבה, או על כל שורה בהיסטוריה.</li><li>בחרו פלטפורמות (Instagram, Facebook, TikTok, YouTube), קבעו תאריך ושעה, וכתבו כיתוב - או הקישו "הצעת כיתוב מהסרטון" כדי שה-AI ינסח אחד מהתמלול (זמין 3 פעמים לכל סרטון).</li><li>כש"פרסום אוטומטי" כבוי (ברירת מחדל), הפוסט ממתין לאישורכם הסופי בתוך Metricool. הפעילו אותו כדי לפרסם אוטומטית.</li><li>צריך קודם חשבון Metricool מחובר (ראו למטה).</li></ul>' },
    ...
    'guide.account.body':  { en: '<ul><li>Each new account starts with 3 free video credits. Processing a video (the Options step) uses at least one credit - a video over 10 minutes and the AI upscale each add one, and you confirm the cost first. If processing fails, the credits are returned.</li><li>Your remaining credits show in the pill at the top of the app.</li><li>Tap the credits pill to buy a non-expiring pack securely through Google Play (in the Android app; on the web the pill shows the way there).</li><li>Need help? Use the Contact link in the footer.</li></ul>', he: '<ul><li>כל חשבון חדש מתחיל עם 3 קרדיטים חינמיים לסרטונים. עיבוד סרטון (שלב האפשרויות) מנצל קרדיט אחד לפחות - סרטון מעל 10 דקות ושדרוג ה-AI מוסיפים קרדיט כל אחד, והעלות מוצגת לאישור מראש. אם העיבוד נכשל, הקרדיטים מוחזרים.</li><li>הקרדיטים שנותרו מוצגים בתווית שבראש האפליקציה.</li><li>הקישו על תווית הקרדיטים כדי לרכוש חבילה שאינה פגה באופן מאובטח דרך Google Play (באפליקציית Android; באתר התווית מכוונת לשם).</li><li>צריכים עזרה? השתמשו בקישור "צרו קשר" בתחתית.</li></ul>' },
    'cost.title':     { en: 'Costs', he: 'עלויות' },
    ...
    'cost.total':     { en: 'Compute', he: 'מחשוב' },
    ...
    'cost.note':      { en: 'Modal + Anthropic list rates, excluding container startup and idle. A floor for pricing decisions, not an invoice.', he: 'לפי מחירוני Modal ו-Anthropic, ללא זמן עליית מכולה והמתנה. רצפה להחלטות תמחור, לא חשבונית.' },
    ...
    'admin.loading':    { en: 'Loading…', he: 'בטעינה…' },
    'admin.loadFailed': { en: 'Could not load users - try again.', he: 'טעינת המשתמשים נכשלה - נסו שוב.' },
    // Admin-only Errors panel. Never rendered for a non-admin: the tab is gated
    // and /admin/errors answers 403.
    'adminErr.title':   { en: 'Recent errors', he: 'שגיאות אחרונות' },
    'adminErr.note':    { en: 'Every user-facing failure, newest first. Tap one to see the job, the options and what the user did just before it broke.', he: 'כל תקלה שמשתמש נתקל בה, מהחדשה לישנה. הקישו על שורה כדי לראות את העבודה, ההגדרות ומה המשתמש עשה רגע לפני.' },
    'adminErr.empty':   { en: 'No errors reported.', he: 'לא דווחו שגיאות.' },
    'adminErr.now':     { en: 'just now', he: 'ממש עכשיו' },
    'adminErr.minutes': { en: '{n} min ago', he: 'לפני {n} דק' },
    'adminErr.hours':   { en: '{n} h ago', he: 'לפני {n} שע' },
    'adminErr.days':    { en: '{n} d ago', he: 'לפני {n} ימים' },
    'adminErr.version': { en: 'Build', he: 'גרסה' },
    'adminErr.job':     { en: 'Job', he: 'עבודה' },
    'adminErr.duration': { en: 'Length', he: 'אורך' },
    'adminErr.options': { en: 'Options', he: 'הגדרות' },
    'adminErr.network': { en: 'Network', he: 'רשת' },
    'adminErr.exception': { en: 'Exception', he: 'חריגה' },
    'adminErr.device':  { en: 'Device', he: 'מכשיר' },
