...
(function () {
  ...
  const I18N = {
    ...
    'auth.sendCode':   { en: 'Send code', he: 'שליחת קוד' },
    ...
    'auth.noAccount':    { en: 'No account found for this email. Go back and choose "I\'m new here".', he: 'לא נמצא חשבון עם האימייל הזה. חזרו ובחרו "חדשים כאן".' },
    'auth.emailTaken':   { en: 'This email already has an account. Go back and choose "I have an account".', he: 'לאימייל הזה כבר יש חשבון. חזרו ובחרו "יש לי חשבון".' },
