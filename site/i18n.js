...
(function () {
  ...
  const I18N = {
    ...
    'guide.intro':      { en: 'Everything you need to turn a Hebrew talking video into a captioned, scheduled reel - in a few taps.', he: 'כל מה שצריך כדי להפוך סרטון דיבור בעברית לריל עם כתוביות ומתוזמן - בכמה הקשות.' },
    'guide.s1.title':   { en: '1 · Sign in', he: '1 · התחברות' },
    'guide.s1.body':    { en: 'Log in with your username and password. New here? Enter your invite code and email to create an account.', he: 'היכנסו עם שם משתמש וסיסמה. משתמשים חדשים - הזינו את קוד ההזמנה והאימייל כדי ליצור חשבון.' },
    'guide.s2.title':   { en: '2 · Connect Metricool (optional)', he: '2 · חיבור Metricool (רשות)' },
    'guide.s2.body':    { en: 'To schedule posts, tap the "Connect Metricool" chip at the top and link your account. One time only.', he: 'כדי לתזמן פוסטים, הקישו על תווית "חיבור Metricool" בראש העמוד וחברו את החשבון שלכם. פעולה חד-פעמית.' },
    'guide.s3.title':   { en: '3 · Upload your video', he: '3 · העלאת סרטון' },
    'guide.s3.body':    { en: 'In the Create tab, pick a Hebrew talking video (up to 500 MB). The clearer the audio, the better the captions. Vertical videos work best for reels.', he: 'בלשונית "יצירה", בחרו סרטון דיבור בעברית (עד 500MB). ככל שהאודיו ברור יותר, הכתוביות מדויקות יותר. סרטונים אנכיים מתאימים במיוחד לרילים.' },
    'guide.s4.title':   { en: '4 · Choose your options', he: '4 · בחירת אפשרויות' },
    'guide.s4.body':    { en: 'Toggle what you need: cut silences, Hebrew captions, audio enhance, and video enhance (up to AI 4K upscale). Each video uses one of your free credits.', he: 'הפעילו לפי הצורך: חיתוך שתיקות, כתוביות בעברית, שיפור אודיו, ושיפור וידאו (עד שדרוג AI ל-4K). כל סרטון מנצל קרדיט אחד מהחינמיים.' },
    'guide.s5.title':   { en: '5 · Process', he: '5 · עיבוד' },
    'guide.s5.body':    { en: 'Tap Run. Keep the window open while uploading; once processing starts you can switch away - it finishes on our servers. You get an auto-cut, captioned video.', he: 'הקישו "הפעלת העיבוד". בזמן ההעלאה השאירו את החלון פתוח; ברגע שהעיבוד מתחיל אפשר לעבור לאפליקציה אחרת - הוא ממשיך בשרת. בסיום מתקבל סרטון חתוך עם כתוביות בעברית.' },
    'guide.s6.title':   { en: '6 · Polish (optional)', he: '6 · עריכה ושכלול (רשות)' },
    'guide.s6.body':    { en: 'Edit captions, add an opening hook, find B-roll clips, or generate a caption suggestion from the video.', he: 'ערכו כתוביות, הוסיפו הוק פותח, מצאו קטעי בי-רול, או הפיקו הצעת כיתוב מתוך הסרטון.' },
    'guide.s7.title':   { en: '7 · Burn & download', he: '7 · צריבה והורדה' },
    'guide.s7.body':    { en: 'Tap Burn to render the captions, hook and B-roll into the final MP4, then download it.', he: 'הקישו "צריבה" כדי לצרוב את הכתוביות, ההוק והבי-רול לסרטון הסופי, ואז הורידו אותו.' },
    'guide.s8.title':   { en: '8 · Schedule to socials (optional)', he: '8 · תזמון לרשתות (רשות)' },
    'guide.s8.body':    { en: 'Tap Schedule (on the video or from History), choose platforms, time and caption, and send to Metricool. Unless Auto-publish is on, you approve the final post inside Metricool.', he: 'הקישו "תזמון" (על הסרטון או מההיסטוריה), בחרו פלטפורמות, שעה וכיתוב, ושלחו ל-Metricool. אלא אם "פרסום אוטומטי" מופעל, אתם מאשרים את הפרסום הסופי ב-Metricool.' },
    'guide.s9.title':   { en: '9 · History', he: '9 · היסטוריה' },
    'guide.s9.body':    { en: 'The History tab keeps finished videos for 30 days - re-download, schedule, or delete.', he: 'לשונית "היסטוריה" שומרת סרטונים מוגמרים ל-30 יום - אפשר להוריד שוב, לתזמן או למחוק.' },
