...
(function () {
  ...
  const I18N = {
    ...
    'wa.annotation':   { en: 'Issue? Feedback? Let us know so we can improve before the official launch.', he: 'בעיה? משוב? ספרו לנו כדי שנוכל לשפר לפני ההשקה הרשמית.' },
    ...
    'auth.googleNeedInvite': { en: 'Almost there - enter your invite code and accept the terms, then continue with Google again.', he: 'עוד רגע - הזינו קוד הזמנה ואשרו את התנאים, ואז המשיכו עם Google שוב.' },
    ...
    'auth.newHere':    { en: 'Enter your invite code and accept the terms, then continue with Google or email.', he: 'הזינו קוד הזמנה ואשרו את התנאים, ואז המשיכו עם Google או אימייל.' },
    ...
    'autherr.invalid_invite':{ en: 'Invalid invite code.', he: 'קוד ההזמנה שגוי.' },
    ...
    'guide.getstarted.body':  { en: 'Signing in is passwordless: continue with Google, or get a 6-digit code by email. Every account comes with a few free video credits (see Account & credits below).<ul><li><b>Existing users</b> - choose "I have an account", then Google or the email code.</li><li><b>New here?</b> Choose "I\'m new here", enter your invite code and accept the terms, then continue the same way.</li><li>Got a "no account found" message? Tap the Create an account button in it to switch.</li></ul>', he: 'ההתחברות בלי סיסמה: המשיכו עם Google, או קבלו קוד בן 6 ספרות למייל. לכל חשבון יש כמה קרדיטים חינמיים לסרטונים (ראו "חשבון וקרדיטים" למטה).<ul><li><b>משתמשים קיימים</b> - בחרו "יש לי חשבון", ואז Google או קוד למייל.</li><li><b>חדשים כאן?</b> בחרו "חדשים כאן", הזינו קוד הזמנה ואשרו את התנאים, ואז המשיכו באותו אופן.</li><li>קיבלתם הודעת "לא נמצא חשבון"? הקישו על כפתור "ליצירת חשבון" שבתוכה כדי לעבור.</li></ul>' },
